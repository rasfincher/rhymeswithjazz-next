...
const HeaderName = forwardRef(function HeaderName(
  ...
  return (
    <p
      ref={ref}
      className="header-name ml-2 text-xl font-medium text-gray-600 dark:text-gray-300 capture-pointer-events grid-rows-1 grid-cols-1 items-center"
      onClick={onClick}
    >
      {postTitle && (
        <span className="post-title text-sm row-start-1 col-start-1">
          {postTitle}
        </span>
      )}
